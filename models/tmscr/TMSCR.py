...
class MSTransPoseNet(nn.Module):
    ...
    def __init__(self, config, pretrained_path):
        ...
        self.query_embed = nn.Embedding(num_kps, decoder_dim)

        self.xyz_regressor = nn.Sequential(nn.Linear(decoder_dim, decoder_dim * 2), nn.GELU(),
